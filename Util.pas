...
Function CurrToWordsRU(C:Currency; P:Byte):String;
 begin
  ...
  Result:=IntToWordsRU(Trunc(C),P)+' гривен '+LeadZero(Trunc(100*(C-Trunc(C))))+' копеек'
 end;
...
var F:System.Text;
 ...
 begin
  ...
  try
   ...
   System.Close(F);
   B:=False;
   if Not (B1) then Application.MessageBox(PChar('Чтение файла накладных произощло с ошибками!'+#10#10+
